...
| Os atores presentes no storyboard são coerentes com a realidade?                                       | Objetiva (SIM/NÃO) | Identificar problemas de interação |
| A sequência de ações leva ao objetivo final?                                                           | Objetiva (SIM/NÃO) | Identificar problemas de interação |
| O storyboard propõe maneiras mais eficientes ou interessantes de os usuários atingirem seus objetivos? | Objetiva (SIM/NÃO) | Identificar problemas de interação |
| O storyboard representa a tarefa que ele está relacionado?                                             | Objetiva (SIM/NÃO) | Identificar problemas de interação |
| As ações dos atores seguem uma ordem justificável e coesa?                                             | Objetiva (SIM/NÃO) | Identificar problemas de interação |
