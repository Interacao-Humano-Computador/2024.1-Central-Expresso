...
Para corrigir isso, sugerimos a adição de botões visíveis e descritivos na interface, utilizando ícones reconhecíveis e cores contrastantes. Redesenhar a navegação para priorizar a compra de passagens, proporcionando feedback visual ao clicar nos botões, ajudará a alinhar o sistema com as expectativas dos usuários, melhorando a usabilidade e satisfação.

<font size="2"><p style="text-align: center"> Figura 1 - Correspondência com as expectativas dos usuários </p></font>

<center> ![alt text](principio1.png) </center>
...
Para simplificar este processo, é recomendado integrar sistemas de pagamento modernos que permitam a confirmação automática do pagamento diretamente na plataforma. Automatizando essa etapa, o sistema eliminaria a necessidade de envio de comprovantes por e-mail, tornando a transação mais fluida e eficiente. Essa mudança reduziria a insegurança e a frustração do cliente, melhorando a usabilidade e satisfação geral.

<font size="2"><p style="text-align: center"> Figura 2 - Simplicidade nas Estruturas das Tarefas </p></font>

<center> ![alt text](principio2.png) </center>
...
Para melhorar o equilíbrio entre controle e liberdade, a interface deve permitir filtros detalhados, como a seleção de localidades e linhas de ônibus específicas. Isso proporcionaria uma experiência mais flexível e eficiente, permitindo que os usuários acessem rapidamente as informações desejadas sem navegar por dados irrelevantes, aumentando a satisfação e a eficiência do uso.

<font size="2"><p style="text-align: center"> Figura 3 - Equilíbrio entre Controle e Liberdade do Usuário </p></font>

<center> ![alt text](principio3.png) </center>
...
<font size="2"><p style="text-align: center"> Figura 4 - Promoção da Eficiência do Usuário </p></font>

<center> ![alt text](principio4.png) </center>
...
Para resolver essa questão, a interface deve incluir uma funcionalidade que permita aos usuários visualizar e acompanhar o status do pedido facilmente. Isso pode ser implementado através de um painel de controle ou de notificações automáticas via e-mail ou SMS que atualizem o usuário sobre o andamento do pedido.

<font size="2"><p style="text-align: center"> Figura 5 - Visibilidade e Reconhecimento </p></font>

<center> ![alt text](principio5.png) </center>
...
Para resolver essa violação, o botão de compra deve ser reposicionado em uma área mais intuitiva da interface, preferencialmente no topo ou no centro da págin. Além disso, o botão deve ser visualmente destacado com cores contrastantes e rótulos claros, como "Comprar Agora", para que seja imediatamente reconhecível e compreensível. 

<font size="2"><p style="text-align: center"> Figura 6 - Conteúdo Relevante e Expressão Adequada </p></font>

<center> ![alt text](principio6.png) </center>
